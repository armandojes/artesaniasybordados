        ...
        <Container>
          <Box pb={{ xs: 5, md: 10 }} pt={{ xs: 5, md: 10 }}>
            <ContainerMaterialStyled>
              <Paragraph>
                Artesanias chiapas nace para impulsar a nuestros artesanos chiapanecos promoviendo el genuino arte popular chiapaneco y a sus creadores, con el fomento y difusión dentro y fuera de sus espacios.
              </Paragraph>
              <Paragraph>
